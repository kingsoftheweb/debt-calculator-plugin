									...
									<div class="debt-calculator">
										<div class="result">
											<div class="result-text">
												<h1><span id="bmiValue">24.8 </span>kg/m2</h1><small
													id="bmid">Normal</small>
											</div>
										</div>
										<div class="calculator">
											...
											<div class="height">
												<input class="value_range" id="height" type="range" value="182"
												       min="100" max="250" step="1"
												       style="background-image: -webkit-gradient(linear, 0% 0%, 100% 0%, color-stop(0.02, rgb(247, 57, 70)), color-stop(0.02, rgb(39, 40, 58)));">
												<div class="label-height field-text">103</div>
											</div>
											<div class="weight">
												<input class="value_range" id="weight" type="range" value="82" min="0"
												       max="250" step="1"
												       style="background-image: -webkit-gradient(linear, 0% 0%, 100% 0%, color-stop(0.424, rgb(247, 57, 70)), color-stop(0.424, rgb(39, 40, 58)));">
